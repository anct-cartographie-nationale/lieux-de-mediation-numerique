...
const TYPOLOGIE_MATCHERS: TypologieMatcher[] = [
  {
...
const correspond =
  (nom: string) =>
  (trouve: boolean, matcher: RegExp): boolean =>
    trouve || matcher.test(nom);

const typologieCorrespondante =
  (nom: string) =>
