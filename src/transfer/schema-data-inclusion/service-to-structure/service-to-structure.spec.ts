...
describe('service data inclusion to structure data inclusion', (): void => {
  ...
  it('should not override structure phone or email with invalid service phone or email', (): void => {
    const structure: SchemaStructureDataInclusion = {
      ...
      nom: 'CCAS Paris 13',
      siret: '43493312300029',
      telephone: '33685146985',
      courriel: 'contact@ccasparis13.fr'
    };
  ...
  it('should convert service data inclusion with address to structure data inclusion with presentation and contact info from structure', (): void => {
    const structure: SchemaStructureDataInclusion = {
      adresse: '12 rue Baudricourt',
      code_postal: '75013',
      code_insee: '51454',
