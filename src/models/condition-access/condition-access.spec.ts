...
describe('condition access model', (): void => {
  ...
  it('should not create an invalide conditions access', (): void => {
    expect((): void => {
  ...
  it('should not create an invalide conditions access containing a valid and an invalid value', (): void => {
    expect((): void => {
